...
* [X] Découvrir la documentation officielle JavaScript (http://fr.javascript.info/manuals-specifications) : 
    ...
    * [X] Comprendre ce qu'est le `TC-39` 
      Note : version non aboutie de la dernière version de ecma-262 incluant les modifications et devs impliqués dans le
      projet     
    * [X] Lister les bonnes sources de documentation (Javascript.info, Udemy, Google ;) )
...
* [X] Comprendre le fonctionnement et l'utilité du `"use strict"` (http://fr.javascript.info/strict-mode)
    Note: La directive ressemble à une chaînede caractères : "use strict" ou 'use strict'. Lorsqu’il se trouve en haut du script, l’ensemble du script fonctionne de manière “moderne”.
* [X] Comprendre le fonctionnement et l'utilité des variables (http://fr.javascript.info/variables)
    * [X] Comprendre la différence entre `let`, `var` et `const`
          ...
          let : possible de créer une variable Null
          const : crétion de constantes
